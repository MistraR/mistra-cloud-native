...
import (
	"fmt"
	hystrix2 "github.com/MistraR/mistra-cloud-native/base/plugin/hystrix"
...
func main() {
	...
	//2.配置中心，存放经常变动的变量
	consulConfig, err := common.GetConsulConfig("101.132.113.82", 8500, "/micro/config")
	if err != nil {
		common.Error(err)
	}
	...
	//4.添加链路追踪
	t, io, err := common.NewTracer("base", "101.132.113.82:6831")
	if err != nil {
		common.Error(err)
	}
	defer io.Close()
