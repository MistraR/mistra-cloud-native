module github.com/MistraR/mistra-cloud-native/podApi

go 1.24.2

require (
	github.com/MistraR/mistra-cloud-native/common v0.1.0
	github.com/MistraR/mistra-cloud-native/pod v0.0.0-20250503030212-f6daa9ea1788
	...
	github.com/asim/go-micro/plugins/wrapper/select/roundrobin/v3 v3.7.0
